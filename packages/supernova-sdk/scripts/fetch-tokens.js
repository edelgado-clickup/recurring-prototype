...
async function fetchTokens() {
  console.log('🚀 Fetching design tokens from Supernova...\n');
  ...
  try {
    ...
    console.log(`✓ Fetched ${tokens.length} design tokens\n`);

    if (tokens.length === 0) {
      console.warn('⚠️  No tokens found in the design system');
      return;
    }
    ...
    console.log(`✓ Generated SCSS variables: ${scssPath}`);
    ...
    console.log(`✓ Generated CSS custom properties: ${cssPath}`);
    ...
    console.log('\n✅ Design tokens successfully fetched and exported!');
    console.log('\nUsage:');
